...
class Header extends React.Component {
    render() {
        return (
            <div>
                <h1 style={{ color: "black" }}>Daniel R. Sigmund</h1>
                <p>Focused and reliable computer scientist bringing high enthusiasm and extensive knowledge of markup languages.
                    Proven history of excellent customer service and conflict resolution skills. Dedicated to accuracy and streamlining systems
